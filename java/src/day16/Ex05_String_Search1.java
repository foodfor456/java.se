...
public class Ex05_String_Search1 {
	...
	public static void main(String[] args) {
		...
		//	 - 여러개 있어도 처음 시작하는 번지만 찾음.
		/* - 문자열.(검색어, 시작번지)
		 * 	 -문자열에서 시작번지 부터 검색어를 찾아 있으면 시작번지, 없으면 -1*/
		...
		if(index >= 0) {
			...
			if(index >= 0) {
				System.out.println(str + " 문자열에 " + search + " 문자열은 " + index + " 번지 2개 있습니다. ");
			}
			else {
				System.out.println(str + " 문자열에 " + search + " 문자열은 " + index + " 번지 1개 있습니다. ");
			}
		}else {
