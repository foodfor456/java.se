...
public class AccountBookManager implements ConsoleProgram {
	...
	public void readAccountBook() {
		System.out.println("전체 [1], 날짜[2] 선택 : ");
	...
	public boolean modifyAccountBook(){
		...
		System.out.println("===================");
		System.out.println("선택한 항목내역은 다음과 같습니다. ");
		System.out.print("수정하시겠습니까?[예:true/아니오:false]");
		...
		System.out.print("결재 방식을 수정하겠습니까?[예:true/아니오:false] : ");
		ok = scan.nextBoolean();
	...
	private String readItems(int modIndex) {
	...
	public Item deleteAccountBook(){
		...
		return abook.getItem(delIndex-1);
	}
}
