...
public class Ex3_Object {
	...
	public static void main(String[] args) {
		...
		System.out.println("------------");
		//=을 통해 객체를 저장하면 공유하는것, a1과 a3이 같은 객체를 공유
		A a3 = a1;
		//a3의 num1의 값을 변경 => a1의 num1의 값도 같이 변경됨.
		a3.setNum1(3);
...
class A implements Cloneable{
	...
	public boolean equals(Object obj) {
		//두 객체의 저장된 주소가 같은지 확인 => 두 객체가 같은 객체를 공유하는지 확인.
		if(this == obj) {
			return true;
		}
		//상대 객체가 없으면 비교 불가능
	...
	*/
	...
	//일반적인 clone은 얕은 복제이다. 깊은 복제를 하려면 따로 구현해야함.
	@Override
	public Object clone() {
		Object obj = null;
		try {
