...
public class Ex4_Casting {
	...
	public static void main(String[] args) {
		...
		//강제 타입변환 예 : 계산을 위해 특정값을 일시적으로 변환하는 경우
		...
		//num4_1과 더하는 값이 실숙이기 때문에 num4_1을 실수로 자동 타입변환을 할 후 실수 + 실수를 계산하여 num4_3에 저장
		//더할 때 자동 타입변화를 함
		...
		//55~56. 정수를 실수로 자동변환할 때 정밀도가 떨어질 수 있다. int=> float
		//int = float으로 형변환하기 보다 double로 타입변환하여 활용한다.
