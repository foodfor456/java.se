...
public class Ex12_Exception_Throw_Calculator {
	...
	/* 기능 : 두 정수와 산술 연술연산자가 주어지면 산술연산 결과를 알려주는 메소드
	 * 		단, 연산자가 산술연산자가 아니면 예외가 발생.
	 * 매개변수 : 두 정수와 산술 연산자 => int num1, char op, int num2
	 * 리턴타입 : 산술 연산결과 => 실수 => double
	 * 메소드명 : calculator*/
	
	public static double calculator(int num1, char ch, int num2) throws Exception{
		double v = 0;
		switch(ch) {
		case '+': v = num1 + num2; break;
		case '-': v = num1 - num2; break;
		case '*': v = num1 * num2; break;
		case '/':  
		if (num2 == 0) {
