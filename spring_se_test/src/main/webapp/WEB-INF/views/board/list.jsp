...
<div class="container">
  ...
  <table class="table table-hover">
    ...
    <tbody>
 	...
 	<form class="container input-group-prepend">
  ...
  <ul class="pagination form-group justify-content-center">
	  <c:if test="${pm.prev}">
  ...
  <a href="<%=request.getContextPath()%>/board/insert" class="btn btn-outline-primary">글쓰기</a>
</div>
</body>
</html>