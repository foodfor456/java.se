...
public class BoardController {
	...
	public ModelAndView boardUpdateGet(ModelAndView mv,
		...
		BoardVO board = boardService.boardSelect(bd_num);
		ArrayList<FileVO> fileList = boardService.fileSelect(bd_num);
	...
	public ModelAndView boardDeleteGet(ModelAndView mv, HttpSession session, @PathVariable("bd_num") int bd_num){
		MemberVO user = (MemberVO)session.getAttribute("user");
	...
	@ResponseBody
	public Map<Object,Object> BoardImageUpload(@RequestParam("file") MultipartFile file ){
		HashMap<Object, Object> map = new HashMap<Object, Object>();
