...
CREATE TABLE `product` (
  ...
  `pr_thumb` varchar(255) NOT NULL,
  `pr_title` varchar(255) NOT NULL,
  `pr_content` longtext NOT NULL,
  `pr_spec` longtext NOT NULL,
  `pr_price` int DEFAULT NULL,
  `pr_ca_name` varchar(10) NOT NULL,
  PRIMARY KEY (`pr_code`),
  KEY `FK_category_TO_product_1` (`pr_ca_name`),
  CONSTRAINT `FK_category_TO_product_1` FOREIGN KEY (`pr_ca_name`) REFERENCES `category` (`ca_name`)
