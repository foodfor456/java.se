...
<form class="container" enctype="multipart/form-data" method="post" action="<c:url value="/admin/product/update"></c:url>">
	...
	<div class="clearfix">
		...
		<div class="float-right" style="width:calc(100% - 150px - 10px)">
			...
			<div class="form-group">
			  <input type="text" class="form-control" readonly value="${pr.pr_code}" name="pr_code">
			</div>
			<div class="form-group">
			  <input type="text" class="form-control" name="pr_price" placeholder="가격(정수)" value="${pr.pr_price}">
			</div>
		</div>
	</div>
	<div class="form-group">
	  <input type="text" class="form-control" name="pr_title" placeholder="제목" value="${pr.pr_title}">
	</div>
	<div class="form-group">
	  <textarea class="form-control" name="pr_content" placeholder="제품 내용" >${pr.pr_content}</textarea>
	</div>
	<div class="form-group">
