...
<form class="container" enctype="multipart/form-data" method="post">
	...
	<div class="clearfix">
		...
		<div class="float-right" style="width:calc(100% - 150px - 10px)">
			...
			<div class="form-group">
			  <input type="text" class="form-control" name="pr_price" placeholder="가격(정수)">
			</div>
		</div>
	</div>
	<div class="form-group">
	  <input type="text" class="form-control" name="pr_title" placeholder="제목">
	</div>
	<div class="form-group">
	  <textarea class="form-control" name="pr_content" placeholder="제품 내용"></textarea>
	</div>
	<div class="form-group">
